...
function updateThemeUI(theme) {
  ...
  if (lbl) lbl.textContent = theme === 'retro' ? 'Hacker MODE' : 'DEVLOPER MODE';
}
...
function initTerminal() {
  ...
  { text: '> STATUS: READY TO BUILD',                  cls: 'tw-glow'    },
  { text: '> Side-quest: Cybersecurity Research',      cls: 'tw-glitch'  }, // Mentions cyber as secondary
  { cursor: true }
   ];
...
function injectData() {
  ...
  if (rl) {
    // This pulls the path from your portfolioData.js hero.resumeLink
    rl.href = d.hero.resumeLink || "assets/Kartik BhatiaPortfolio.pdf";
  }
}
